...
if __name__ == '__main__':
    ...
    write_script(start_script=0, num_script=3, start_task=0, total_tasks=4325,
                 hours=12, min_node=1, parallel=48, account="rrg-whitem", virt_env="gpu_env") #start_script, num_script, start_task, total_tasks, hours, min_node
    # write_script(start_script=0, num_script=35, start_task=0, total_tasks=51900,
    #              hours=12, min_node=1, parallel=48, account="rrg-whitem", virt_env="gpu_env") #start_script, num_script, start_task, total_tasks, hours, min_node
