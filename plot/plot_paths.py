...
pe_sweep_temp = [
    {"label": "ReLU",
     "control": "data/output/test/picky_eater/representation/dqn/sweep/",
     },
    {"label": "ReLU+Control",
     "control": "data/output/test/picky_eater/representation/dqn_aux/aux_control/sweep/",
     },
    {"label": "ReLU+Reward",
     "control": "data/output/test/picky_eater/representation/dqn_aux/reward/sweep/",
     },
    {"label": "LTA",
     "control": "data/output/test/picky_eater/representation/dqn_lta/sweep/",
     },
    {"label": "LTA+Control",
     "control": "data/output/test/picky_eater/representation/dqn_lta_aux/aux_control/sweep/",
     },
    {"label": "LTA+Reward",
