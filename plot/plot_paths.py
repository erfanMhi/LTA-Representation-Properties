...
gh_nonlinear_transfer_sweep_v13_largeReLU = [
    ...
    {"label": "ReLU(L)+ATC",
     ...
     "fixrep_measure": ["data/output/test_v13/gridhard/nonlinear_vf/original_0909/fixrep_property/dqn_cl/best_large/", 0],
     },
    {"label": "FTA+ATC",
     ...
     "fixrep_measure": ["data/output/test_v13/gridhard/nonlinear_vf/original_0909/fixrep_property/dqn_fta_cl/best/", 0],
     },
