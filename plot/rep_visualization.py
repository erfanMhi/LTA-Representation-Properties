...
if __name__ == '__main__':
    ...
    visualize_umap("experiment/config/test_v13/gridhard/linear_vf/original_0909/online_property/dqn_aux/aux_control/sweep_1g_gamma0.9.json", 1, runs, "umap-relu+control1g")
    visualize_umap("experiment/config/test_v13/gridhard/linear_vf/original_0909/online_property/dqn_aux/aux_control/sweep_5g_gamma0.9.json", 0, runs, "umap-relu+control5g")
    ...
    visualize_umap("experiment/config/test_v13/gridhard/linear_vf/original_0909/online_property/dqn_lta_aux/aux_control/sweep_1g_gamma0.9.json", 2, runs, "umap-fta+control5g")
    visualize_umap("experiment/config/test_v13/gridhard/linear_vf/original_0909/online_property/dqn_lta_aux/aux_control/sweep_5g_gamma0.9.json", 2, runs, "umap-fta+control1g")
