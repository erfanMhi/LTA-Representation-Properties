...
from core.agent import dqn_aux_cl
...
if __name__ == '__main__':
    ...
    cfg.ul_optimizer_fn = optimizer.OptFactory.get_ul_optimizer_fn(cfg)
    cfg.vf_loss_fn = optimizer.OptFactory.get_vf_loss_fn(cfg)
    cfg.vf_constr_fn = optimizer.OptFactory.get_constr_fn(cfg)
    cfg.replay_fn = replay.ReplayFactory.get_ul_replay_fn(cfg)
